...
func NewElectionResult(candidate_name string, votes int) ElectionResult {
...
*/
func DecrementVotesOfCandidate(result map[string]int, candidate_name string) {
	result[candidate_name] -= 1
}
